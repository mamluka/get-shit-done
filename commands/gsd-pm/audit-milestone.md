...
<execution_context>
@~/.claude/gsd-pm/workflows/audit-milestone.md
</execution_context>
...
<process>
Execute the audit-milestone workflow from @~/.claude/gsd-pm/workflows/audit-milestone.md end-to-end.
