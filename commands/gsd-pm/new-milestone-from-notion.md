---
name: gsd-pm:new-milestone-from-notion
...
1. Fetch Notion page content → write `.planning-pm/external-spec.md`
2. Run `/gsd-pm:new-milestone --auto`

**Creates/Updates:**
- `.planning-pm/external-spec.md` — imported spec from Notion
