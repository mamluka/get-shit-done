...
When ready, run:
  /gsd:new-project --auto @.planning/external-spec.md   (for new project)
  /gsd:new-milestone --auto                              (for new milestone)
```
Stop.
...
| Target | Action |
|--------|--------|
| New project | `/gsd:new-project --auto @.planning/external-spec.md` |
| New milestone | `/gsd:new-milestone --auto` |
</process>
