...
Behind the scenes: XML prompt formatting, subagent orchestration, state management. What you see: a few `/gsd:*` commands that just work.
...
/gsd:discuss-phase 1      # Capture implementation decisions (optional)
/gsd:plan-phase 1         # Research + plan + verify + auto-advance
...
| `/gsd:plan-phase [N]` | Research + plan + verify + auto-complete + auto-advance |
...
This fork adds:
- Notion two-way sync (`/gsd:sync-notion`)
- Jira import (`/gsd:sync-jira`)
