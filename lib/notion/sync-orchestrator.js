...
/**
 * Sync all .planning-pm/ markdown files to Notion pages.
 ...
 * If .planning-pm/.active-project exists, uses .planning-pm/<slug>/.
 * Otherwise falls back to .planning-pm/ (flat layout).
 *
