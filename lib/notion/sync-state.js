 ...
 *
 * Manages .planning-pm/notion-sync.json for tracking Notion page IDs per project.
 ...
 * .planning-pm/<slug>/notion-sync.json. Otherwise .planning-pm/notion-sync.json.
 *
 ...
 * @param {object} state - The sync state object
 * @param {string} projectSlug - Project slug identifier
 * @param {string} filePath - Relative file path (e.g., ".planning-pm/phases/06-foundation-sdk-setup/06-RESEARCH.md")
