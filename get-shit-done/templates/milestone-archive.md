...
This template is used by the complete-milestone workflow to create archive files in `.planning-pm/milestones/`.
...
_For current project status, see .planning-pm/ROADMAP.md_
...
- Save to `.planning-pm/milestones/v{VERSION}-{NAME}.md`
- Example: `.planning-pm/milestones/v1.0-mvp.md`
