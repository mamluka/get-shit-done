...
Template for `.planning-pm/phases/XX-name/{phase}-UAT.md` — persistent UAT session tracking.
...
- This section feeds directly into /gsd-pm:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /gsd-pm:plan-phase --gaps with root causes
...
**Creation:** When /gsd-pm:verify-work starts new session
