...
Template for `.planning-pm/phases/XX-name/{phase}-RESEARCH.md` - comprehensive ecosystem research before planning.
...
**CRITICAL:** If CONTEXT.md exists from /gsd-pm:discuss-phase, copy locked decisions here verbatim. These MUST be honored by the planner.
...
**After creation:**
- File lives in phase directory: `.planning-pm/phases/XX-name/{phase}-RESEARCH.md`
