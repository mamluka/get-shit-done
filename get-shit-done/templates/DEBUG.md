...
Template for `.planning-pm/debug/[slug].md` — active debug session tracking.
...
**Creation:** Immediately when /gsd-pm:debug is called
...
**On resolution:**
- status → "resolved"
- Move file to .planning-pm/debug/resolved/
