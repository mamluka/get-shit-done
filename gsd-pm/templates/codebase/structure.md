...
- Key files: new-project.md, plan-phase.md, complete-phase.md
...
- Key files: plan-phase.md, research-phase.md
- Subdirectories: None
...
**New Slash Command:**
- Primary code: `commands/gsd-pm/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `gsd-pm/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `gsd-pm/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/gsd-pm/workflows/{name}.md`

**New Reference Document:**
- Implementation: `gsd-pm/references/{name}.md`
