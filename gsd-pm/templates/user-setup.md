...
Template for `.planning-pm/phases/XX-name/{phase}-USER-SETUP.md` - human-required configuration that Claude cannot automate.
...
**Timing:** Generated after tasks complete, before SUMMARY.md creation.
...
**Searchability:** `grep -r "USER-SETUP" .planning-pm/` finds all phases with user requirements.
