...
@~/.claude/gsd-pm/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see @~/.claude/gsd-pm/references/checkpoints.md -->
...
See `~/.claude/gsd-pm/references/tdd.md` for TDD plan structure.
...
See `~/.claude/gsd-pm/templates/user-setup.md` for full schema and examples
...
See `~/.claude/gsd-pm/workflows/verify-phase.md` for verification logic.
