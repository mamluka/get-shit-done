...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /gsd-pm:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/gsd-pm/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/gsd-pm/templates/discovery.md structure:
...
**Output:** `.planning-pm/phases/XX-name/DISCOVERY.md`
</step>
...
1. **Scope the discovery** using ~/.claude/gsd-pm/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/gsd-pm/templates/discovery.md
...
**Output:** `.planning-pm/phases/XX-name/DISCOVERY.md` (comprehensive)
</step>
...
Use ~/.claude/gsd-pm/templates/discovery.md.
...
Write `.planning-pm/phases/XX-name/DISCOVERY.md`:
- Summary with recommendation
...
```
Discovery complete: .planning-pm/phases/XX-name/DISCOVERY.md
Recommendation: [one-liner]
Confidence: [level]

What's next?

1. Discuss phase context (/gsd-pm:discuss-phase [current-phase])
2. Create phase plan (/gsd-pm:plan-phase [current-phase])
