...
```bash
SAVED_KEY=$(node ~/.claude/gsd-pm/bin/gsd-tools.js config-get jira.project_key 2>/dev/null || echo "")
SAVED_ID=$(node ~/.claude/gsd-pm/bin/gsd-tools.js config-get jira.project_id 2>/dev/null || echo "")
SAVED_CLOUD=$(node ~/.claude/gsd-pm/bin/gsd-tools.js config-get jira.cloud_id 2>/dev/null || echo "")
```
...
```bash
node ~/.claude/gsd-pm/bin/gsd-tools.js config-set jira.cloud_id "{cloud_id}"
node ~/.claude/gsd-pm/bin/gsd-tools.js config-set jira.project_id "{project_id}"
node ~/.claude/gsd-pm/bin/gsd-tools.js config-set jira.project_key "{project_key}"
```
...
```bash
node ~/.claude/gsd-pm/bin/gsd-tools.js config-set jira.granularity "{granularity}"
```
...
```bash
CLOUD_ID=$(node ~/.claude/gsd-pm/bin/gsd-tools.js config-get jira.cloud_id)
PROJECT_KEY=$(node ~/.claude/gsd-pm/bin/gsd-tools.js config-get jira.project_key)
PROJECT_ID=$(node ~/.claude/gsd-pm/bin/gsd-tools.js config-get jira.project_id)
```
