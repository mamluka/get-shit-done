...
```bash
INIT=$(node ~/.claude/gsd-pm/bin/gsd-tools.js init new-project)
```
...
```bash
MIGRATE=$(node ~/.claude/gsd-pm/bin/gsd-tools.js project migrate-folder)
```
...
Setup guides:
  Atlassian Cloud: .claude/gsd-pm/templates/mcp-setup/jira-rovo.md
  Jira Server/DC:  .claude/gsd-pm/templates/mcp-setup/jira-community.md
...
```bash
node ~/.claude/gsd-pm/bin/gsd-tools.js config-set jira_mcp_available true
node ~/.claude/gsd-pm/bin/gsd-tools.js config-set jira_mcp_server "${jira_mcp.serverName}"
```
...
Execute migration:
```bash
MIGRATE_RESULT=$(node ~/.claude/gsd-pm/bin/gsd-tools.js project migrate "{existingProjectName}" "{description}" --raw)
```
...
```bash
SLUG=$(node ~/.claude/gsd-pm/bin/gsd-tools.js generate-slug "{name}")
```
...
```bash
CREATE_RESULT=$(node ~/.claude/gsd-pm/bin/gsd-tools.js project create "{name}" "{description}" --raw)
```
...
```bash
node ~/.claude/gsd-pm/bin/gsd-tools.js project switch "{slug}" --raw
```
...
```bash
mkdir -p .planning-pm
node ~/.claude/gsd-pm/bin/gsd-tools.js commit "docs: initialize project" --files .planning-pm/PROJECT.md
```
...
```bash
node ~/.claude/gsd-pm/bin/gsd-tools.js config-init-recommended
```
...
```bash
node ~/.claude/gsd-pm/bin/gsd-tools.js commit "chore: add project config" --files .planning-pm/config.json
```
...
Use template: ~/.claude/gsd-pm/templates/research-project/STACK.md
</output>
...
Use template: ~/.claude/gsd-pm/templates/research-project/FEATURES.md
</output>
...
Use template: ~/.claude/gsd-pm/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: ~/.claude/gsd-pm/templates/research-project/PITFALLS.md
</output>
...
Use template: ~/.claude/gsd-pm/templates/research-project/SUMMARY.md
...
```bash
node ~/.claude/gsd-pm/bin/gsd-tools.js commit "docs: define v1 requirements" --files .planning-pm/REQUIREMENTS.md
```
...
```bash
node ~/.claude/gsd-pm/bin/gsd-tools.js commit "docs: create roadmap ([N] phases)" --files .planning-pm/ROADMAP.md .planning-pm/STATE.md .planning-pm/REQUIREMENTS.md
```
