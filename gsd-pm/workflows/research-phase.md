...
@~/.claude/gsd-pm/references/model-profile-resolution.md
...
@~/.claude/gsd-pm/references/phase-argument-parsing.md
...
node ~/.claude/gsd-pm/bin/gsd-tools.js state-snapshot | jq '.decisions'
```
