...
```bash
node ~/.claude/gsd-pm/bin/gsd-tools.js commit "docs: start milestone v[X.Y] [Name]" --files .planning-pm/PROJECT.md .planning-pm/STATE.md
```

## 7. Load Context and Resolve Models

```bash
INIT=$(node ~/.claude/gsd-pm/bin/gsd-tools.js init new-milestone)
```
...
node ~/.claude/gsd-pm/bin/gsd-tools.js config-set workflow.research true

# If "Skip research": persist false
node ~/.claude/gsd-pm/bin/gsd-tools.js config-set workflow.research false
```
...
Use template: ~/.claude/gsd-pm/templates/research-project/{FILE}
</output>
...
**Commit requirements:**
```bash
node ~/.claude/gsd-pm/bin/gsd-tools.js commit "docs: define milestone v[X.Y] requirements" --files .planning-pm/REQUIREMENTS.md
```
...
```bash
node ~/.claude/gsd-pm/bin/gsd-tools.js commit "docs: create milestone v[X.Y] roadmap ([N] phases)" --files .planning-pm/ROADMAP.md .planning-pm/STATE.md .planning-pm/REQUIREMENTS.md
```
