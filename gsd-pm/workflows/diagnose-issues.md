...
```bash
node ~/.claude/gsd-pm/bin/gsd-tools.js commit "docs({phase}): add root causes from diagnosis" --files ".planning-pm/phases/XX-name/{phase}-UAT.md"
```
</step>
