...
must_haves:
  ...
  artifacts:
    ...
    - path: ".claude/get-shit-done/workflows/create-project.md"
      provides: "Interactive project creation workflow"
      contains: "project name"
    - path: ".claude/get-shit-done/workflows/switch-project.md"
      provides: "Project switching workflow"
      contains: "switch"
    - path: ".claude/get-shit-done/workflows/list-projects.md"
      provides: "Project listing workflow"
      contains: "list"
    - path: ".claude/commands/gsd/create-project.md"
      provides: "Slash command entry point for /gsd:create-project"
      contains: "create-project"
    - path: ".claude/commands/gsd/switch-project.md"
      provides: "Slash command entry point for /gsd:switch-project"
      contains: "switch-project"
    - path: ".claude/commands/gsd/list-projects.md"
      provides: "Slash command entry point for /gsd:list-projects"
      contains: "list-projects"
  key_links:
    - from: ".claude/commands/gsd/create-project.md"
      to: ".claude/get-shit-done/workflows/create-project.md"
...
```bash
grep -n "createProjectInternal\|switchProjectInternal\|listProjectsInternal\|cmdInitCreateProject\|getActiveProject" .claude/get-shit-done/bin/gsd-tools.js | head -20
```
...
node ./.claude/get-shit-done/bin/gsd-tools.js init list-projects --raw
```
  </verify>
...
**1. `.claude/commands/gsd/create-project.md`:**
```markdown
First, read ./.claude/get-shit-done/workflows/create-project.md for full instructions.

$ARGUMENTS
```
(Follow the pattern of existing commands like `.claude/commands/gsd/new-project.md`)

**2. `.claude/commands/gsd/switch-project.md`:**
```markdown
First, read ./.claude/get-shit-done/workflows/switch-project.md for full instructions.

$ARGUMENTS
```

**3. `.claude/commands/gsd/list-projects.md`:**
```markdown
First, read ./.claude/get-shit-done/workflows/list-projects.md for full instructions.

$ARGUMENTS
```

**4. `.claude/get-shit-done/workflows/create-project.md`:**
...
node ./.claude/get-shit-done/bin/gsd-tools.js project create "{friendlyName}" "{description}"
```
...
If commit_docs:
  node ./.claude/get-shit-done/bin/gsd-tools.js commit "docs: create project {slug}" --files .planning/{slug}/PROJECT.md .planning/{slug}/v1/STATE.md
...
**5. `.claude/get-shit-done/workflows/switch-project.md`:**
...
```bash
node ./.claude/get-shit-done/bin/gsd-tools.js project switch "{selectedSlug}"
```
...
**6. `.claude/get-shit-done/workflows/list-projects.md`:**
...
```bash
ls -la .claude/commands/gsd/create-project.md .claude/commands/gsd/switch-project.md .claude/commands/gsd/list-projects.md .claude/get-shit-done/workflows/create-project.md .claude/get-shit-done/workflows/switch-project.md .claude/get-shit-done/workflows/list-projects.md
```
...
<verification>
1. `node ./.claude/get-shit-done/bin/gsd-tools.js project list --raw` returns valid JSON (empty array is fine)
2. `node ./.claude/get-shit-done/bin/gsd-tools.js init create-project --raw` returns valid JSON
3. `ls .claude/commands/gsd/create-project.md .claude/commands/gsd/switch-project.md .claude/commands/gsd/list-projects.md` all exist
4. `ls .claude/get-shit-done/workflows/create-project.md .claude/get-shit-done/workflows/switch-project.md .claude/get-shit-done/workflows/list-projects.md` all exist
5. `node --test .claude/get-shit-done/bin/gsd-tools.test.js` passes
6. `grep "active_project" .claude/get-shit-done/bin/gsd-tools.js | wc -l` returns 10+ (present in all init commands)
</verification>
